...
IWYU_RAW_INC="-I. -I.. $(pkg-config --cflags girepository-2.0 mozjs-140)"
...
for FILE in $SRCDIR/gi/arg-types-inl.h $SRCDIR/gi/js-value-inl.h \
    $SRCDIR/gi/info.h $SRCDIR/gi/utils-inl.h $SRCDIR/cjs/auto.h \
    $SRCDIR/cjs/enum-utils.h $SRCDIR/cjs/gerror-result.h \
    $SRCDIR/cjs/jsapi-util-args.h $SRCDIR/cjs/jsapi-util-root.h \
...
for FILE in $SRCDIR/gi/*.cpp $SRCDIR/cjs/atoms.cpp $SRCDIR/cjs/byteArray.cpp \
    ...
    $SRCDIR/cjs/deprecation.cpp $SRCDIR/cjs/engine.cpp \
    $SRCDIR/cjs/error-types.cpp $SRCDIR/cjs/global.cpp \
    $SRCDIR/cjs/internal.cpp $SRCDIR/cjs/importer.cpp \
    $SRCDIR/cjs/jsapi-util*.cpp $SRCDIR/cjs/mainloop.cpp \
    $SRCDIR/cjs/module.cpp $SRCDIR/cjs/native.cpp \
    $SRCDIR/cjs/objectbox.cpp $SRCDIR/cjs/promise.cpp $SRCDIR/cjs/stack.cpp \
    $SRCDIR/cjs/text-encoding.cpp $SRCDIR/modules/cairo-*.cpp \
...
for STEM in cjs/context cjs/mem cjs/profiler modules/cairo; do
