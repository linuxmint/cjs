...
const MyComplexGtkSubclass = GObject.registerClass({
    Template: ByteArray.fromString(createTemplate('Cjs_MyComplexGtkSubclass')),
...
out.put_string(createTemplate('Cjs_MyComplexGtkSubclassFromFile'), null);
out.close(null);
...
describe('Gtk overrides', function () {
    ...
    it('avoid crashing when GTK vfuncs are called in garbage collection', function () {
        ...
        GLib.test_assert_expected_messages_internal('Cjs', 'testGtk.js', 0,
